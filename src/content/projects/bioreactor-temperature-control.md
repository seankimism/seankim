...
Scheduled feed boluses are now modeled at all three scales (see [Feeding](#feeding-when-the-culture-volume-changes)). Remaining work: sampling and bleeding, feeds pumped over a finite time rather than added at once, perfusion inlet and harvest stream heat, and evaporation.
