...
Choose a media volume between **400 and 2,000 L**, then select **Simulate** to recalculate the temperature response. Changing the volume updates the liquid level and the thermal model. The inlet, initial-temperature, and room conditions remain the same.
