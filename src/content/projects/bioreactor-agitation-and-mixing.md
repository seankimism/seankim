...
For the other datasets, I calculated mixing numbers as $(\mathrm{rpm}/60)t_{95}$; speeds inferred from tip velocity depend on the assumed impeller diameter. XDR power numbers come from Cytiva customer correspondence dated July 2024 and tank/impeller dimensions from [EP2663629B1, Table 1](https://patents.google.com/patent/EP2663629B1/en), while the total-pair power number of 1.3 for STR/UniVessel follows [De Wilde et al. (2014)](https://www.bioprocessintl.com/single-use/superior-scalability-of-single-use-bioreactors). The scaled STR geometry and the effective cylindrical UniVessel geometry are approximations.
