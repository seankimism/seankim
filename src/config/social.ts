...
export const SOCIALS: SocialLink[] = [
    ...
    { name: "Google Scholar", href: "https://scholar.google.com/citations?user=WE92tgwAAAAJ", linkTitle: "Sean Kim on Google Scholar", isActive: true },
    { name: "Github", href: "https://github.com/seankimism", linkTitle: "Sean Kim on GitHub", isActive: false },
